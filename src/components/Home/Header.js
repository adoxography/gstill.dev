    ...
    >
      ...
      >
        ...
        <img
          src={profileImage}
          alt="Graham Still"
          className={`shadow-lg relative z-10 h-64 w-64 object-contain transform scale-y-0 transition-all duration-500 ease-in-out origin-top ${imageInView ? 'scale-y-100' : ''}`}
          style={imageStyles}
        />
      </div>
    </section>
